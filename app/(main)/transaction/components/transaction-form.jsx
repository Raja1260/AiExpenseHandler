      ...
      <div className="space-y-2">
        ...
        <Popover>
          <PopoverTrigger asChild>
            <Button
              className="w-full pl-3 text-left font-normal flex items-center justify-between"
              variant="outline"
            >
          ...
          <PopoverContent className="w-auto p-0" align="start">
            <SimpleCalendar date={date} setValue={setValue} />
          </PopoverContent>
        </Popover>
